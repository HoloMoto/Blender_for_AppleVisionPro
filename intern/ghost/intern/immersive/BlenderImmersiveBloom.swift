 ...
 *
 * Build with Xcode that provides XROS 27+ SDK (sets BLENDER_HAS_XROS_27_SDK).
 * Runtime no-op on visionOS < 27. Immersive Space only (shared space ignores bloom).
 *
