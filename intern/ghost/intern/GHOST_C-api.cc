                                                   ...
                                                   void *user_data)
{
  ...
  return system->presentOpenDocumentPicker(callback, user_data);
}
...
{
  GHOST_SystemIOS *system = dynamic_cast<GHOST_SystemIOS *>(GHOST_ISystem::getSystem());
  if (system == nullptr || local_blend_path == nullptr) {
    return false;
  }
  return system->presentExportDocumentPicker(local_blend_path, callback, user_data);
}
                                         ...
                                         const size_t final_path_max)
{
  ...
  return system->commitExportFile(
