...
void uiTemplateStatusInfo(uiLayout *layout, bContext *C)
{
  ...
  uiLayout *row = &layout->row(true);
  const bool has_extensions_ops =
      WM_operatortype_find("EXTENSIONS_OT_userpref_show_online", false) &&
      WM_operatortype_find("EXTENSIONS_OT_userpref_show_for_update", false);
  ...
  if ((U.statusbar_flag & STATUSBAR_SHOW_EXTENSIONS_UPDATES) && has_extensions_ops) {
