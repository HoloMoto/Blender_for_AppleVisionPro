...
/**
 * iOS is single-window: collapse extra top-level #wmWindow entries and re-bootstrap screens.
 */
void wm_ios_ensure_single_window(bContext *C, wmWindowManager *wm, const bool relayout);
/** Temp overlay (e.g. Preferences) sharing the primary GHOST surface, or nullptr. */
