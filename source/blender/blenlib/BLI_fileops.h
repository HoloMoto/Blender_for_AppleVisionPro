...
/**
 * True when \a data is the text of a Git LFS pointer file (not real binary content).
 * Common when `git lfs pull` was not run before building or packaging datafiles.
 */
bool BLI_file_data_is_git_lfs_pointer(const void *data, size_t data_len);
/**
