...
struct ForeachGeometryElementInputItemsAccessor
  ...
  inline static const StringRefNull node_idname = "GeometryNodeForeachGeometryElementOutput";
  static constexpr bool has_type = true;
  static constexpr bool has_name = true;
  struct operator_idnames {
    inline static const StringRefNull add_item =
        "NODE_OT_foreach_geometry_element_zone_input_item_add";
    inline static const StringRefNull remove_item =
        "NODE_OT_foreach_geometry_element_zone_input_item_remove";
    inline static const StringRefNull move_item =
        "NODE_OT_foreach_geometry_element_zone_input_item_move";
  };
  struct ui_idnames {
    inline static const StringRefNull list = "DATA_UL_foreach_geometry_element_input_items";
  };
  struct rna_names {
...
struct ForeachGeometryElementMainItemsAccessor : public socket_items::SocketItemsAccessorDefaults {
  ...
  struct ui_idnames {
    inline static const StringRefNull list = "DATA_UL_foreach_geometry_element_main_items";
  };
  struct rna_names {
    inline static const StringRefNull items = "main_items";
    inline static const StringRefNull active_index = "active_main_index";
  };
...
struct ForeachGeometryElementGenerationItemsAccessor
  ...
  struct ui_idnames {
    inline static const StringRefNull list = "DATA_UL_foreach_geometry_element_generation_items";
  };
  struct rna_names {
    inline static const StringRefNull items = "generation_items";
    inline static const StringRefNull active_index = "active_generation_index";
  };
