...
if(WITH_APPLE_CROSSPLATFORM)
  ...
  if(${CMAKE_GENERATOR} MATCHES "Xcode")
    # Use the generic SDK name (e.g. iphoneos) so Xcode projects keep working
    # when the active Xcode install updates its platform SDK version.
    set(CMAKE_XCODE_ATTRIBUTE_SDKROOT ${APPLE_SDK_CROSSPLATFORM_NAME_LOWER})
  endif()
  unset(OSX_SDKROOT)
